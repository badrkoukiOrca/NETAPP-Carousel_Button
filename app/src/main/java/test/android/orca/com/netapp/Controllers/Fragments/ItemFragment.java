...
import test.android.orca.com.netapp.Controllers.CarouselLinearLayout;
...
public class ItemFragment extends Fragment {
    ...
    public static Fragment newInstance(MainActivity context, int pos, float scale, ArrayList<String> Users) {
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Picasso.with(getActivity().getApplicationContext()).load(list.get(postion)).into(imageView);
