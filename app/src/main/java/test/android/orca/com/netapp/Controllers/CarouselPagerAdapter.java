package test.android.orca.com.netapp.Controllers;
...
import test.android.orca.com.netapp.Controllers.Fragments.ItemFragment;
...
public class CarouselPagerAdapter extends FragmentPagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public CarouselPagerAdapter(MainActivity context, FragmentManager fm, ArrayList<String> Users) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        return ItemFragment.newInstance(context, position, scale, Users);
    }
